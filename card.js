    ...
    choices: [
      {
        ...
        value: () => {
          ...
          const mailto = [
            ` ${chalk.yellow.bold("arpit.absyadav@gmail.com")}`,
            "",
          ].join("\n");
...
const data = {
  name: chalk.bold.green(
    "             Arpit Yadav [ arpit.absyadav@gmail.com ]"
  ),
  ...
  linkedin:
    chalk.gray("https://linkedin.com/in/") + chalk.blue("arpitabsyadav"),
  web: chalk.cyan("https://arpit-absyadav.github.io"),
  stackoverflow:
    chalk.gray("https://stackoverflow.com/users/") +
    chalk.blue("2165443/arpit-yadav"),
